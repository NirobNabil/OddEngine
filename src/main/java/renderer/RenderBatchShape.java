...
//    // float, float, float, float, float, float     float, float, float, float      Int, Int, Int, Int, Int, Int
//    private final int POS_ELEM_COUNT = 6;
...
//        shader = new Shader("assets/shaders/shapeShader.glsl");
//        shader.compile();
//        this.shapes = new ShapeRenderer[maxBatchSize];
